...
type ComputeRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Iterations    int32                  `protobuf:"varint,1,opt,name=iterations,proto3" json:"iterations,omitempty"` // Number of iterations for computation
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ComputeRequest) GetIterations() int32 {
	if x != nil {
		return x.Iterations
	}
	return 0
...
var file_proto_benchmark_benchmark_proto_rawDesc = []byte{
	...
	0x6d, 0x2f, 0x72, 0x61, 0x64, 0x69, 0x75, 0x73, 0x78, 0x79, 0x7a, 0x2f, 0x6c, 0x69, 0x67, 0x68,
	0x74, 0x62, 0x75, 0x6c, 0x62, 0x2d, 0x74, 0x64, 0x78, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f,
