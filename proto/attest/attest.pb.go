...
func (x *AttestRequest) GetReportData() []byte {
	if x != nil {
		return x.ReportData
	}
	return nil
...
func (x *AttestReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AttestReply) ProtoMessage() {}

func (x *AttestReply) ProtoReflect() protoreflect.Message {
	mi := &file_proto_attest_attest_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AttestReply.ProtoReflect.Descriptor instead.
func (*AttestReply) Descriptor() ([]byte, []int) {
	return file_proto_attest_attest_proto_rawDescGZIP(), []int{1}
}

func (x *AttestReply) GetQuote() string {
	if x != nil {
		return x.Quote
	}
	return ""
...
var file_proto_attest_attest_proto_rawDesc = []byte{
	...
	,
	...
	0x75, 0x6c, 0x62, 0x2d, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f,
...
var file_proto_attest_attest_proto_goTypes = []any{
	(*AttestRequest)(nil), // 0: attest.AttestRequest
	(*AttestReply)(nil),   // 1: attest.AttestReply
}
var file_proto_attest_attest_proto_depIdxs = []int32{
	0, // 0: attest.AttestService.Attest:input_type -> attest.AttestRequest
	1, // 1: attest.AttestService.Attest:output_type -> attest.AttestReply
